...
PassFirefox::PassFirefox() : m_box1 { Gtk::Orientation::ORIENTATION_VERTICAL },
  ...
  set_title("Exportart e Importar Senhas para o Firefox");
...
void PassFirefox::draw_widgets() {
  ...
  // Fixed
  m_fixed.set_size_request( 320, 400 );
  ...
  m_label3.set_text( "Importar arquivo GPG, insura sua senha para importar" );
  ...
  m_linkbutton.set_label( "durval.com.br" );
  m_linkbutton.set_uri( "https://durval.com.br" );
